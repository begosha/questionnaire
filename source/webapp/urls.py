...
from .views import (IndexView, PollAddView, PollView, PollUpdateView, PollDeleteView, ChoiceCreateView, ChoiceUpdateView, ChoiceDeleteView, AnswerAddView)
...
urlpatterns = [
    ...
    path('<int:pk>/add/answer', AnswerAddView.as_view(), name='answer-add'),
]